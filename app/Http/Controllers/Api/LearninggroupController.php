...
class LearninggroupController extends Controller
{
    ...
    public function index()
    {
        ...
        try {
            ...
            if($data->count() > 0){ 
                return $this->success('Learning Groups retrieved successfully', $data);
            }else{
                return $this->error('Learning Groups Not Found.', [],400);
            } 
        } catch (\Exception $e) {
    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            DB::commit(); 
            if($executes){
                return $this->success('Learning Groups updated successfully', []);
            } 
        } catch (\Exception $e) {
            DB::rollBack();
            return $this->error($e->getMessage(), $e->getCode());
